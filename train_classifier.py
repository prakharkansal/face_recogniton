...
if __name__ == '__main__':
    ...
    parser.add_argument('--input-dir1', type=str, action='store', default='/medium-facenet-tutorial/user_name/data', dest='input_dir1')
    parser.add_argument('--output-dir1', type=str, action='store', default='/medium-facenet-tutorial/user_name/output/intermediate', dest='output_dir1')
    parser.add_argument('--crop-dim', type=int, action='store', default=180, dest='crop_dim',
                        help='Size to crop images to')
    args = parser.parse_args()

    import zipfile
    zip_ref = zipfile.ZipFile('/medium-facenet-tutorial/user_name/data.zip', 'r')
    zip_ref.extractall('/medium-facenet-tutorial/user_name')
    zip_ref.close()
    preprocess_train.main(args.input_dir1, args.output_dir1, args.crop_dim)
